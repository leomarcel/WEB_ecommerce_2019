...
class SaleItemDarkModeProvisioningCommand extends Command
{

    protected static $defaultName = 'app:sale-item-dark-mode-provisioning';
    private $doctrine;
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this
            ->setName('app:sale-item-dark-mode-provisioning')
